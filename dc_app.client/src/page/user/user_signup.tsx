  ...
  return (
    <div>
      <Card className="user-form-card">
        <Card.Title className="user-form-title">Sign Up</Card.Title>
        <Form onSubmit={handleSubmit}>
          ...
          <Button className="user-form-button"  variant="primary" type="submit">Sign Up</Button>
        </Form>
        ...
        <div className="form-bottom">
          ...
          <p>Already have an account?&nbsp;
            <span onClick={navToLogIn} style={{ 'cursor': 'pointer', 'color': 'blue', 'textDecoration': 'underline' }}>
              Log in
            </span>
          </p>
        </div>
